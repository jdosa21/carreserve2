            ...
            <%@ include file="/include/lib.jsp" %>
                ...
                <script>
                    ...
                    function setStrTime(tagArea, h) {
                        ...
                        alert(document.getElementById('endTime' + (h + 2)).checked);
                        for (i = h; i < 24; i++) {
                                                            ...
                                                            <div class="mainCotnWrap jejuOn" id="tabOn">
                                                                ...
                                                                <form id="resume_form" method="post"
                                                                    ...
                                                                    <input type="hidden" id="destination"
                                                                        name="destination" value="${list.destination}">
                                                                    <c:set var="rsDateUp"
                                                                        value="${fn:split(list.rsDate,' ')}" />
                                                                    <c:set var="reDateUp"
                                                                        value="${fn:split(list.reDate,' ')}" />
                                                                    <c:set var="reDateRe"
                                                                        value="${fn:split(rsDateUp[1],'.')}" />
                                                                    <c:set var="reDateRe"
                                                                        value="${fn:split(reDateUp[1],'.')}" />
