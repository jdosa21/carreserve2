                                                ...
                                                <div id="sp_main_wrapper" class="wrap_main_panel"
                                                    ...
                                                    <div class="main_option ">
                                                        <form id="search_panel_form" name="search_panel_form"
                                                                    action="../log/search.do" method="get"
                                                                    onkeydown="return event.key != 'Enter';">
                                                        <div style="width: 100%; display: flex;">
                                                            <div class="sri_select resume_select" id="a"
                                                                style="width: 10%;">
                                                                <button type="button" class="ico_arr selected"
                                                                ...
                                                                <ul class="list_opt" style="width: 99%;">
                                                                    <label for="tartTime"
                                                                        ...
                                                                        <li class="link_opt">
                                                                            전체&nbsp&nbsp&nbsp&nbsp&nbsp<input type="radio" name="sType"
                                                                                value="all" id="tartTime"
                                                                                style="display: none; margin:0;" checked>
                                                                        </li>
                                                                    </label>
                                                                    <label for="tartTime2" onclick="openPop3()">
                                                                        <li class="link_opt">
                                                                            차종&nbsp&nbsp&nbsp&nbsp&nbsp<input type="radio" name="sType"
                                                                                value="car" id="tartTime2"
                                                                    ...
                                                                    <label for="tartTime5"
                                                                        onclick="selectRadio1('rsTimeTxt','a1')">
                                                                        <li class="link_opt">
                                                                            예약자&nbsp&nbsp&nbsp&nbsp&nbsp<input type="radio" name="sType"
                                                                                value="name" id="tartTime5"
                                                                                style="display: none; margin:0;">
                                                                        </li>
                                                                    </label>
                                                                </ul>
                                                            ...
                                                            <ul class="tab_section" style="width: 80%;">
                                                                <li class="keyword_section " style="width: 100%;">
                                                                    <button type="button"
                                                                        ...
                                                                        style="width: 100%;">
                                                                        <input type="hidden" id="s_keyword"
                                                                            name="searchWord">
                                                                        <input type="text" name="search_word"
                                                                            id="area_ipt_keyword" placeholder="검색어 입력"
                                                                            autocomplete="off" value="" minlength="2"
                                                ...
                                                <table class="table table-bordered table-hover">
                                                    <tbody>
                                                        ...
                                                        <c:forEach var="data" items="${list}" varStatus="status">
                                                            <tr>
                                                                <td id="carId_${data.logId }"><a
                                                                        href="javascript:updateSet('${data.logId }')">${data.logId}</a>
                                                                </td>
                                                                <td id="carType_${data.logId }">
                                                                    ${list1[status.index].carType }</td>
                                                                <td id="carNum_${data.logId }" style="width: 30%;">
                                                                    ${data.rsPurpose }</td>
                                                                <td id="distance_${data.logId }">${data.drvDistance }
                                                                </td>
                                                                <td id="drivingAt_${data.logId }" style="width: 30%;">
                                                                    ${data.note }</td>
                                                                <td style="display: none;" id="rs_${data.logId }">
                                                                    ${data.rsId }</td>
                                                                <td>김성철</td>
                                                            </tr>
                                                        </c:forEach>
                                            ...
                                            <div id="carUp" class="container"
                                                ...
                                                <div class=" col-sm-12">
                                                    <form class="form-horizontal" method="post"
                                                        action="../log/update.do">
                                                        <input type="hidden" id="carIdUp" name="logId">
                                                        <input type="hidden" id="drivingAtUp" name="rsId">
                                                        <table class="table table-bordered table-hover aaa">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" class="form-control"
                                                                        name="rsPurpose" id="carTypeUp" minlength="1"
                                                            ...
                                                            <tr>
                                                                <td>주행 거리</td>
                                                                <td><input type="text" class="form-control"
                                                                        name="drvDistance" id="carNumUp" minlength="1"
